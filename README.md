...
## 📜 License (라이선스)
이 프로젝트는 **MIT License**를 따릅니다. 자세한 내용은 [LICENSE](LICENSE) 파일을 확인하세요.

## 🤝 Contributing (기여하기)
프로젝트 기여에 관한 가이드는 [CONTRIBUTING.md](CONTRIBUTING.md)를 참고해 주세요. 행동 강령은 [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md)에 명시되어 있습니다.